...
public final class ActivityOauthBinding implements ViewBinding {
  ...
  private ActivityOauthBinding(@NonNull LinearLayout rootView, @NonNull LinearLayout progressLayout,
  ...
  public static ActivityOauthBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityOauthBinding((LinearLayout) rootView, progressLayout, webView);
    }
